                ...
                <table id="data" class="table table-striped table no-margin">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <a class="btn btn-xs btn-primary btn-flat" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-edit"> </span></a> 
                                 <!-- Add patient  -->
                                <div class="container">
                                    <!-- Modal -->
                                                    ...
                                                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/update-patient-details') }}">
                                                        ...
                                                        <div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }}">
                                                            ...
                                                            <div class="col-lg-6 col-md-8 col-sm-12">
                                                                <input id="first_name" type="text" class="form-control" name="first_name" value="{{$data->first_name}}" required>
                                                        ...
                                                        <div class="form-group{{ $errors->has('second_name') ? ' has-error' : '' }}">
                                                            ...
                                                            <div class="col-lg-6 col-md-8 col-sm-12">
                                                                <input id="second_name" type="text" class="form-control" name="second_name" value="{{ $data->second_name  }}" required>
                                                        ...
                                                        <div class="form-group{{ $errors->has('id_number') ? ' has-error' : '' }}">
                                                            ...
                                                            <div class="col-lg-6 col-md-8 col-sm-12">
                                                                <input id="id_number" type="number" class="form-control" name="id_number" value="{{$data->id_number}}" required>
                                                        ...
                                                        <div class="form-group{{ $errors->has('cell_phone') ? ' has-error' : '' }}">
                                                            ...
                                                            <div class="col-lg-6 col-md-8 col-sm-12">
                                                                <input id="cell_phone" type="number" class="form-control" name="cell_phone" value="{{App\Models\PatientsContactDetail::where('patient_meta_data_id', $data->id)->value('cell_phone')}}" required>
                                                        ...
                                                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                                            ...
                                                            <div class="col-lg-6 col-md-8 col-sm-12">
                                                                <input id="email" type="email" class="form-control" name="email" value="{{App\Models\PatientsContactDetail::where('patient_meta_data_id', $data->id)->value('email')}}" required>
                                                        ...
                                                        <div class="form-group{{ $errors->has('alternative_cell_number') ? ' has-error' : '' }}">
                                                            ...
                                                            <div class="col-lg-6 col-md-8 col-sm-12">
                                                                <input id="alternative_cell_number" type="number" class="form-control" name="alternative_cell_number" value="{{App\Models\PatientsContactDetail::where('patient_meta_data_id', $data->id)->value('alternative_cell_number')}}" required>
                                                      ...
                                                      <p class="col-md-offset-2">Location Details</p>
                                                        ...
                                                        <div class="form-group{{ $errors->has('village') ? ' has-error' : '' }}">
                                                            ...
                                                            <div class="col-lg-6 col-md-8 col-sm-12">
                                                                <input id="village" type="text" class="form-control" name="village" value="{{App\Models\PatientsAddress::where('patient_meta_data_id', $data->id)->value('village')}}" required>
                                                        ...
                                                        <div class="form-group{{ $errors->has('ward') ? ' has-error' : '' }}">
                                                            ...
                                                            <div class="col-lg-6 col-md-8 col-sm-12">
                                                                <input id="ward" type="text" class="form-control" name="ward" value="{{App\Models\PatientsAddress::where('patient_meta_data_id', $data->id)->value('ward')}}" required>
                                                        ...
                                                        <div class="form-group{{ $errors->has('subcounty') ? ' has-error' : '' }}">
                                                            ...
                                                            <div class="col-lg-6 col-md-8 col-sm-12">
                                                                <input id="subcounty" type="text" class="form-control" name="subcounty" value="{{App\Models\PatientsAddress::where('patient_meta_data_id', $data->id)->value('subcounty')}}" required>
                                                        ...
                                                        <div class="form-group{{ $errors->has('county') ? ' has-error' : '' }}">
                                                            ...
                                                            <div class="col-lg-6 col-md-8 col-sm-12">
                                                                <input id="county" type="text" class="form-control" name="county" value="{{App\Models\PatientsAddress::where('patient_meta_data_id', $data->id)->value('county')}}" required>
                                                        ...
                                                        <div class="form-group{{ $errors->has('next_of_kin_name') ? ' has-error' : '' }}">
                                                            ...
                                                            <div class="col-lg-6 col-md-8 col-sm-12">
                                                                <input id="next_of_kin_name" type="text" class="form-control" name="next_of_kin_name" value="{{App\Models\PatientsKinDatum::where('patient_meta_data_id', $data->id)->value('next_of_kin_name')}}" required>
                                                        ...
                                                        <div class="form-group{{ $errors->has('next_of_kin_phone') ? ' has-error' : '' }}">
                                                            ...
                                                            <div class="col-lg-6 col-md-8 col-sm-12">
                                                                <input id="next_of_kin_phone" type="number" class="form-control" name="next_of_kin_phone" value="{{App\Models\PatientsKinDatum::where('patient_meta_data_id', $data->id)->value('next_of_kin_phone')}}" required>
                                                        ...
                                                        <div class="form-group{{ $errors->has('next_of_kin_id_number') ? ' has-error' : '' }}">
                                                            ...
                                                            <div class="col-lg-6 col-md-8 col-sm-12">
                                                                <input id="next_of_kin_id_number" type="number" class="form-control" name="next_of_kin_id_number" value="{{App\Models\PatientsKinDatum::where('patient_meta_data_id', $data->id)->value('next_of_kin_id_number')}}" required>
                                                        ...
                                                        <div class="form-group{{ $errors->has('enrollment_number') ? ' has-error' : '' }}">
                                                            ...
                                                            <div class="col-lg-6 col-md-8 col-sm-12">
                                                                <input id="enrollment_number" type="text" class="form-control" name="enrollment_number" value="{{App\Models\PatientsEnrollmentDetail::where('patient_meta_data_id', $data->id)->value('enrollment_number')}}" required>
