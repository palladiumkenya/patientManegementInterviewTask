...
class PatientGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Patient entity")
        ...
        .repeat(2) {
            ...
            .post("/api/patients")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "surname":"SAMPLE_TEXT", "otherNames":"SAMPLE_TEXT", "dateOfBirth":"2020-01-01T00:00:00.000Z", "county":"SAMPLE_TEXT", "subcounty":"SAMPLE_TEXT", "ward":"SAMPLE_TEXT", "village":"SAMPLE_TEXT", "isDeleted":null}""")).asJSON
            .check(status.is(201))
